...
public class ai_vi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ai_vi);
        ...
        videoResponseCall.enqueue(new Callback<BaseResponse>() {
            ...
            public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(ai_vi.this, "Error: " + response.message(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<BaseResponse> call, Throwable t) {
                ...
                Toast.makeText(ai_vi.this, "Failure: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                saveUserCourseCall.enqueue(new Callback<BaseResponse>() {
                    ...
                    public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(ai_vi.this, "Error: " + errorBody, Toast.LENGTH_SHORT).show();
                        }
                    }
