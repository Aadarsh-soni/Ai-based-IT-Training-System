...
public class ja_exp extends AppCompatActivity {
                ...
                apiResponseCall.enqueue(new Callback<BaseResponse>() {
                    ...
                    public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(ja_exp.this, "Error: " + errorBody, Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<BaseResponse> call, Throwable t) {
                        // Handle failure/error in making the API call
                        Toast.makeText(ja_exp.this, "Failure: " + t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void openOnClick(User user, UserPreferenceForm userPreferenceForm) {
        Intent intent = new Intent(this, andro_vi.class);
