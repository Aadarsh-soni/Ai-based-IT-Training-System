...
public class ns_exp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ns_exp);
                ...
                apiResponseCall.enqueue(new Callback<BaseResponse>() {
                    ...
                    public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(ns_exp.this, "Error: " + errorBody, Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<BaseResponse> call, Throwable t) {
                        // Handle failure/error in making the API call
                        Toast.makeText(ns_exp.this, "Failure: " + t.getMessage(), Toast.LENGTH_SHORT).show();
